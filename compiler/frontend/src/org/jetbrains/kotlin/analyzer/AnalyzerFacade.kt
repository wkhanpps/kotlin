...
private object DiagnoseUnknownModuleInfoReporter {
            ...
            name.contains(ResolverForProject.resolverForModulesName) -> {
                when {
                    ...
                    infos.size == 1 -> {
                        ...
                        when {
                            infoAsString.contains("ScriptDependencies") ->
                                errorInModulesResolverWithScriptDependencies(message)
    ...
    private fun reportOther(message: String): Nothing = throw AssertionError(message)
}